...
* Heroic: 2 Leute mit Lila Kreis, diesen zur Mitte überlappend ablegen
...
**Enrage:**  
**Positionierung:**  
**Besonderheiten:** Raid in 2 Gruppen aufteilen, Bosse 60 Meter voneinander Tanken, müssen gleichzeitig sterben  

* Tanks:  
 * Flarendo: Eruption Stomp macht hohen Magie Schaden
 * Torq: Lightning Bash macht hohen Physikalischen Schaden
* Healer: 
 * Torq: Lightning Bash macht hohen Physikalischen Schaden und wird auf den Raid verteilt
* DDs: 
...
* Scapbomb muss von allen gesoaked werden  
* Spieler wird mit Laser anvisiert, sobald gelocked rauslaufen  
* Tank: Eruption Stomp macht hohen Magie Schaden  
* Heroic: Feuerkreise verteilen, nicht in 2 stehen  

#####Torq Team:  

* Spieler erzeugen "Static Charge" wenn sie sich bewegen, wenn die Bar voll ist → Spieler wird gestuned  
 * Heroic: Man stuned alle Spieler 10 Meter um sich
* Thunderdrum Salvo → Ausweichen mit "Stutter Steps"
* Tank/Heal: Lightning Bash macht hohen Physikalischen Schaden und wird auf den Raid verteilt  
* Heroic: "Voltaic Images" verfolgen einen 12 Sekunden, nicht treffen lassen, CC + wegrennen  
...
**HT:**  Pull  
**Enrage:**  Emplifier volle Energie, beim 3. mal P2 erreichen  (unendliche Anzahl an Ringen, noch Angreifbar bis man nicht mehr springen kann)   
...
* Blue Circle: keinen Amplifier drainen, nicht überlappen, nicht drin stehen (AoE DMG)
* Heroic: Barrels spawnen, müssen getötet werden. Nach 15 Sekunden explodieren sie - genug DMG am Raid bei 1 Barrel für wipe.
...
* Heroic:
 * Territorial Bombshell: Spawnen auf Müllhaufen, müssen auf 75% gekloppt werden um vom Müllhaufen geholt zu werden. Nach 30 Sekunden explodieren die Bomben und wipen den Raid (evtl. 1 überlebbar)
...
* Tanks:
 * Gravi-Gunk: erhöht erlittenen Schaden + verlangsamt, spott bei 5 Stacks oder Pyro Party Pack   
 * Pyro Party Pack: Bomnbe aus dem Raid tragen, anderer Tank muss spotten
...
####P2
* Raid wird an den Eingang geschuppst und muss zum Boss laufen
